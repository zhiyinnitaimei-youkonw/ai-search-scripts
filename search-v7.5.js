...
// ========== 路由 ==========
var ROUTES = {
  "@game":  { o: ["bilibili","moegirl","bwiki_ys","bwiki_sr","bwiki_ak","bwiki_zzz","bwiki_bh3","bwiki_blhx","bwiki_zmd","bwiki_ww","bwiki_gbf","prts_wiki","bing"], min: 2 },
  ...
  "@web":   { o: ["bing","bilibili"], min: 1 },
  "@all":   { o: ["bing","bilibili","juejin","moegirl","bwiki_ys","bwiki_sr","bwiki_ak","bwiki_zzz","bwiki_bh3","bwiki_blhx","bwiki_zmd","bwiki_ww","bwiki_gbf","prts_wiki","baike"], min: 99 }
};
